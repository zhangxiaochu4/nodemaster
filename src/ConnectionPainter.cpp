...
namespace QtNodes
{
    ...
    static void drawNormalLine(QPainter *painter, ConnectionGraphicsObject const &cgo)
    {
        ...
        if (connectionStyle.useDataDefinedColors())
        {
            ...
            auto dataTypeOut = graphModel.portData(cId.outNodeId, PortType::Out, cId.outPortIndex, PortRole::DataType).value<NodeDataType>();

            auto dataTypeIn = graphModel.portData(cId.inNodeId, PortType::In, cId.inPortIndex, PortRole::DataType).value<NodeDataType>();
